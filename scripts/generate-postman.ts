      ...
      item: [
        {
          ...
          request: {
            ...
            description: 'Register a new user. A verification email is sent — login is blocked until the email is verified. In dev/staging the verificationToken is returned in the response (and auto-saved).',
          },
          response: [],
        },
        {
        ...
        },
        {
          ...
          request: {
            ...
            description: 'Re-send the verification email. Returns 200 even if the email is not found (prevent enumeration). Returns 409 if already verified. In dev/staging the token is returned and auto-saved.',
          },
          response: [],
        },
        {
